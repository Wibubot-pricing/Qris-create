...
echo "[+] Pilih Pilihan Berikut: ";
 echo "[+] 1.Dengan Nominal:
 echo "[+] 2.Tanpa Nominal:
       if ($fee == '1') {
           echo "[+] Silahkan masukkan nominal Rp: ";
           echo "[+] Silahkan masukkan nama toko: ";
           echo "[+] Silahkan masukkan nomer whatsapp anda: ";
           $qris = trim(fgets(STDIN));
           echo "[+]qris anda akan segera kami kirimkan silahkan whatsapp owner kami di +6285868055463 untuk meminta qris
